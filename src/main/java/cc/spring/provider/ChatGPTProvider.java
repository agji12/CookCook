...
public class ChatGPTProvider {
	...
	public JsonObject extractIngredients(String sendMsg) throws Exception{
		...
		String assistantMessage1 = "{\"role\": \"assistant\", \"content\": \"{\\\"비빔밥\\\":[\\\"밥\\\",\\\"고추장\\\",\\\"참기름\\\",\\\"간장\\\",\\\"다진 소고기\\\",\\\"단호박\\\",\\\"시금치\\\",\\\"콩나물\\\",\\\"시금치\\\",\\\"당근\\\",\\\"계란\\\",\\\"김\\\"],\\\"김치찌개\\\":[\\\"김치\\\",\\\"두부\\\",\\\"돼지고기\\\",\\\"양파\\\",\\\"대파\\\",\\\"고춧가루\\\",\\\"소금\\\",\\\"설탕\\\"],\\\"프렌치토스트\\\":[\\\"식빵\\\",\\\"달걀\\\",\\\"우유\\\",\\\"설탕\\\",\\\"버터\\\"]}\"}";
		String systemMessage2 = "{\"role\": \"system\", \"content\": \"" + sendMsg + "\"}";
